...
object AppUtil {
    ...
    private fun getLauncherApps(
        ...
        val launchablesMap: MutableMap<ComponentName, AppMetaData>  = HashMap(availableActivities.size)
        availableActivities
            .filter {
...
//                if (mFilter?.hiddeApp(packageName) != true) {
                    ...
                    val isSystemApp = flag.and(ApplicationInfo.FLAG_SYSTEM) != 0 || flag.and(ApplicationInfo.FLAG_UPDATED_SYSTEM_APP) != 0
                    ...
                    val metaData = AppMetaData(info.label as String, componentName, icon, { view ->
                        ...
                        { context->
                            ...
                            val packageLaunchIntent = context.packageManager.getLaunchIntentForPackage(packageName)
                            launchApp(
                                context,
